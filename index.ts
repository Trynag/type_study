...
// const miles = createHero({name: 'Miles Morales', age: 15})
...
// const addressSebastian: Address = {
//     planet: 'Earth',
//     city: 'Caldas'
// }
...
// const arrowFunction = ((a) => "some") // Cambia internamente el como trata al this
...
// if (canvas canvas instanceof HTMLCanvasElement) { // Debi!= null && do a esta validacion, TypeScript detecta que es un elemento
